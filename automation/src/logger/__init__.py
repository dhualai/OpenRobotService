...
Usage:
    from automation.src.logger import setup_logging, get_logger
...
from automation.src.logger.config import LogConfig
from automation.src.logger.core import get_logger, reset_logging, setup_logging
