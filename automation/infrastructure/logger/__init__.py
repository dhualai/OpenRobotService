...
Usage:
    from automation.infrastructure.logger import setup_logging, get_logger
...
from automation.infrastructure.logger.config import LogConfig
from automation.infrastructure.logger.core import get_logger, reset_logging, setup_logging
