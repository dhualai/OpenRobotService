...
使用方法：
    # 导入单个文件
    python -m ai.ingestion.loader docs/manual.md

    # 导入目录
    python -m ai.ingestion.loader docs/

    # 重新导入（清空后重建）
    python -m ai.ingestion.loader docs/ --rebuild
"""
import os
import re
import glob
...
async def ingest_documents(
    ...
    Returns:
        导入统计信息
    """
    from ai.core.retrieval import QdrantClientWrapper as QdrantWrapper
