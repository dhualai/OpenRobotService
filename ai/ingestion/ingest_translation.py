...
使用方法：
    python -m ai.ingestion.ingest_translation --rebuild
    python -m ai.ingestion.ingest_translation --dry-run
    python -m ai.ingestion.ingest_translation --cleanup
"""
import sys
import hashlib
import asyncio
...
async def main():
    import argparse
    from datetime import datetime
    from ai.config import get_active_translation_collection, _write_active_translation_collection
