...
使用方法：
    ...
    python -m ai.ingestion.ingest_all --dry-run    # 预览（仅排查树支持）
    python -m ai.ingestion.ingest_all --skip manual # 跳过操作手册
    python -m ai.ingestion.ingest_all --skip faq    # 跳过 FAQ
    python -m ai.ingestion.ingest_all --skip troubleshooting  # 跳过排查树
"""
import sys
import asyncio
