# AiTaskPlatform — 目标架构设计文档（v4.0，已归档）

> **状态**：已归档。改造点 A/B/C/D/E/F + discuss_flow 收敛 + 能力注册表 均已于 2026-08-14 落地并编译验证。
> **说明**：本文档为历史设计稿，保留供审计参考。当前生产接口以 `ai/api/router.py` 实际挂载为准。
> **日期**：2026-08-13（设计） / 2026-08-14（实现） / 2026-09-18（归档）
