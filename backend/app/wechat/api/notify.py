"""通知路由——从 das/api/notify.py 迁移而来，合入 wechat 模块。

MIGRATION.md 阶段 3：将 das/notify 通知功能合入 app/wechat/。
"""
from fastapi import APIRouter, HTTPException, Depends, Request
from typing import Optional, List, Dict, Any
from app.modules.admin.schemas_das.request_models import NotifyRequest, NotifyResponse
...
from app.wechat.services.wechat_service import WechatService
