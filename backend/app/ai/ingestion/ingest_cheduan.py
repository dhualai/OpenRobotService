...
使用方法：
    python -m app.ai.ingestion.ingest_cheduan --rebuild
    python -m app.ai.ingestion.ingest_cheduan --dry-run
    python -m app.ai.ingestion.ingest_cheduan --cleanup
"""
import sys
import hashlib
import asyncio
...
async def auto_ingest() -> bool:
    ...
    from app.ai.config import _write_active_cheduan_collection
...
async def main():
    import argparse
    from datetime import datetime
    from app.ai.config import get_active_cheduan_collection, _write_active_cheduan_collection
