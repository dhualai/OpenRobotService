...
from app.modules.wechat.schemas.message import SendMessageRequest, BroadcastMessageRequest, TemplateMessageRequest, SendLinkMessageRequest, ApiResponse, SendNotificationRequest, NotificationResponse
