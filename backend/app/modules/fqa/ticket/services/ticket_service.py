...
from app.modules.fqa.ticket.models.ticket import Ticket, TicketComment, TicketStatus, TicketPriority, TicketType
from app.modules.fqa.ticket.schemas.ticket import TicketCreate, TicketUpdate, TicketCommentCreate, TicketCommentUpdate, TicketQueryParams, TicketFilterRequest
from app.core.config import settings
from app.modules.fqa.utils.notification_utils import NotificationUtils
from app.modules.fqa.utils.image_processor import ImageProcessor
...
class TicketService:
    ...
    async def _get_user_map(cls, token: Optional[str] = None) -> Dict[str, str]:
        ...
        try:
            aas_url = settings.USER_CENTER_BASE_URL
