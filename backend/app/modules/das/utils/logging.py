...
LOG_CONFIG_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'logging_config.json')
...
DEFAULT_LOG_CONFIG = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "level": "INFO",
            "formatter": "standard",
            "filename": os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'logs', 'das.log'),
            "when": "midnight",
            "interval": 1,
            "backupCount": 30,
            "encoding": "utf-8"
