...
from app.modules.das.schemas.request_models import DailyReportCreate, DailyReportUpdate, DailyReportResponse
from app.modules.das.services.daily_report_service import daily_report_service
from app.modules.das.utils.config import security, DEBUG_MODE

daily_report_router = APIRouter(prefix="/daily-reports", tags=["daily-reports"])
