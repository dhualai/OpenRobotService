...
from app.modules.das.schemas.request_models import ProjectCreate, ProjectUpdate, ProjectResponse
from app.modules.das.services.project_service import project_service
...
async def create_project(
    ...
    try:
        ...
        from app.modules.das.utils.security import decode_token
...
async def create_project_license(
    ...
    license = project_service.create_license(license_data)
    return license
