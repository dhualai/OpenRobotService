...
from app.modules.das.schemas.request_models import ProjectBase, ProjectCreate, ProjectUpdate
from app.modules.das.models.models import Project
from app.modules.das.utils.config import DATABASE_URL, AUTH_SERVICE_BASE_URL
...
class ProjectService:
    ...
    def create_license(self, license_data: Dict) -> Dict:
        from app.modules.das.models.models import ProjectLicense
